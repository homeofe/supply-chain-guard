...
function formatSbom(report: ScanReport): string {
  ...
  const sbom = {
    ...
    metadata: {
      ...
      tools: {
        components: [
          { type: "application", name: "supply-chain-guard", version: "5.23.5" },
        ],
      },
      component: {
...
<div class="container">
  ...
  <footer>
    Generated by <a href="https://github.com/homeofe/supply-chain-guard">supply-chain-guard</a> v5.23.5
  </footer>
</div>
<script>
