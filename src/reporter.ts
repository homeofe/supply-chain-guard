...
function formatSbom(report: ScanReport): string {
  ...
  const sbom = {
    ...
    metadata: {
      ...
      tools: {
        components: [
          { type: "application", name: "supply-chain-guard", version: "5.25.6" },
        ],
      },
      component: {
...
<div class="container">
  ...
  <footer>
    Generated by <a href="https://github.com/homeofe/supply-chain-guard">supply-chain-guard</a> v5.25.6
  </footer>
</div>
<script>
