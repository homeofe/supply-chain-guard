...
// recommendations and devcontainer files, "maven" from pom.xml and Gradle files; "jenkins" has no lockfile the
...
const ECOSYSTEM_VALUES = ["npm", "pypi", "ruby", "composer", "nuget", "go", "jenkins", "terraform", "vscode", "openvsx", "maven"] as const;
 ...
 */
const PREFIXED_ECOSYSTEMS = ["ruby:", "composer:", "nuget:", "go:", "jenkins:", "terraform:", "vscode:", "openvsx:", "maven:"];
