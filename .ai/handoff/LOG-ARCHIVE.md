# supply-chain-guard: Archived Agent Journal

> Older entries rotated from LOG.md. Append-only.

> Archived 2026-07-18: LOG.md became a GENERATED release journal (derived from
> CHANGELOG.md, gated by check:handoff) to end the append-drift that left it
> unmaintained across v5.3.0-v5.17.3. The hand-authored entries that predate that
> change are preserved below verbatim, newest first.
