...
feed 20,144 -> 20,187. All 10 bare names were probed against the npm registry and
...
20,187 to about 30,000 (+49 percent) and `feed.json` from 4.7 MB to roughly 7 MB
