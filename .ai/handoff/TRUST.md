...
|----------|-------|------------|--------|
| package.json version | 5.23.1 | tool_verified | package.json |
| Source modules present | 73 | tool_verified | src/ file list |
| Test files present | 104 | tool_verified | src/__tests__/ file list |
