...
We would love recipes for additional CI systems - CircleCI, Jenkins, and
Azure Pipelines are on the wishlist (check the issue tracker for open
`help wanted` issues). To contribute:
